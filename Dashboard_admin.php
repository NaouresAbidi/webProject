            ...
            <div class="main-left">
                ...
                <div class="events">
                        ...
                        if (isset($_POST['approve_email'])) {
                            ...
                            // Update the status attribute to 'verified'
                        ...
                        $sql = "SELECT * FROM users WHERE USER_TYPE = 'organizer' AND status IS NULL";
                        $stmt = $pdo->prepare($sql);
                        $stmt->execute();
            ...
            <div class="main-right">
                ...
                <div class="events">
                        ...
                        foreach ($verifiedOrganizers as $organizer) {
                            ...
                            echo '<div class="event-btns">';
                            echo '<a href="Event.html"><input type="button" value="Display"></a>';
